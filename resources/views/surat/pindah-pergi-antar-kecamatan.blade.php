...
<page orientation="portrait" format="210x330" style="font-size: 10pt">
        <table style="float:right;position:relative">
                <tr>
                    <td valign="top" style="padding: 0px 20px; border: solid 1px black;"><strong>F.1-30</strong></td>
                </tr>
            </table>
    <table>
        <tr>
    ...
    <p style="text-align: center;">
        <strong style="font-size: 12pt;">SURAT KETERANGAN PINDAH WNI</strong><br>
    ...
    <table class="disdukcapil">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>b. Kecamatan</td>
            <td colspan=8 class="kotak">{{Kustom::kapital($item->kecamatan_2)}}</td>
            <td colspan=4 class="tengah">d. Provinsi</td>
            <td colspan=10 class="kotak">{{Kustom::kapital("Jawa tengah")}}</td>
        </tr>
        <tr>
