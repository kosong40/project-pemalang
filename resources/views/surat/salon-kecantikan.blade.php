...
<p style="font-size:12pt" align="center"><b>IZIN USAHA PARIWISATA (SALON KECANTIKAN)</b></p><br>
@elseif($rm == "Balik Nama")
<p style="font-size:12pt" align="center"><b>IZIN USAHA PARIWISATA (BALIK NAMA SALON KECANTIKAN)</b></p><br>
@else 
<p style="font-size:12pt" align="center"><b>IZIN USAHA PARIWISATA (DAFTAR ULANG SALON KECANTIKAN)</b></p><br>
@endif
...
<table>
    <tr>
        ...
        <td>
           <p align="justify">
            @if($rm == "Permohonan Baru")
            Surat Permohonan dari Sdr. {{$item->nama}} yang beralamat di {{$item->jalan}} Rt {{$item->rt}} .Rw. {{$item->rw}} {{$item->jenis_daerah}} {{$item->nama_daerah}}  perihal permohonan Tanda Daftar Usaha Pariwisata (Salon Kecantikan)
            @elseif($rm == "Balik Nama")
            Surat Permohonan Balik Nama Izin Usaha Salon Kecantikan dari Sdr {{$item->nama}} yang beralamat di {{$item->jalan}} Rt {{$item->rt}} .Rw. {{$item->rw}} {{$item->jenis_daerah}} {{$item->nama_daerah}}  perihal permohonan Izin Usaha Pariwisata (Salon Kecantikan) yang semula Sdr. {{$item->nama_usaha_baru}} menjadi Sdr. {{$item->nama}} 
            @else 
            Surat Permohonan dari Sdr. {{$item->nama}} yang beralamat di {$item->jalan}} Rt {{$item->rt}} .Rw. {{$item->rw}} {{$item->jenis_daerah}} {{$item->nama_daerah}}  perihal permohonan Izin Usaha Pariwisata (Salon Kecantikan).
            @endif
    ...
    <tr>
        ...
        <td>
           <p align="justify">
             KEPUTUSAN BUPATI PEMALANG TENTANG PEMBERIAN IZIN USAHA PARIWISATA (SALON KECANTIKAN)
           </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <p align="justify">
            Memberikan Izin Usaha Pariwisata (Salon Kecantikan) Kepada : 
            </p>
            <table>
                <tr>
