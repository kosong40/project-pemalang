...
<p style="font-size:12pt" align="center"><b>IZIN USAHA PARIWISATA (ATRAKSI WISATA)</b></p><br>
...
<table>
    <tr>
        ...
        <td valign="top">:</td>
        <td>
           <p align="justify">Surat Permohonan dari Sdr {{$item->nama}} yang beralamat di {{$item->jalan}} Rt {{$item->rt}} .Rw. {{$item->rw}} {{$item->jenis_daerah}} {{$item->nama_daerah}}   Kecamatan Pemalang Kabupaten Pemalang perihal permohonan Izin Usaha Atraksi Wisata.</p>
        </td>
    </tr>
    <tr>
        <td valign="top">
        ...
        <td>
            <p align="justify">
                <ol type="a" style="margin:0">
                    <li>
                        bahwa persyaratan izin usaha Atraksi Wisata telah dipenuhi;
                    </li>
                    <li>
                        bahwa sehubungan dengan itu dipandang perlu mengabulkan pemberian izin usaha Atraksi Wisata.
                    </li>
                </ol>
            </p>
        </td>
    ...
    <tr>
        ...
        <td>
           <p align="justify">
           KEPUTUSAN CAMAT PEMALANG TENTANG PEMBERIAN IZIN USAHA PARIWISATA (ATRAKSI WISATA)
           </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <table>
                ...
                <tr>
                    <td valign="top" style="width:4cm"><p>Umur </p></td>
                    <td valign="top"><p>:</p></td>
                    <td><p>{{$item->umur}}</p></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top"><p>Alamat Rumah</p></td>
                    <td valign="top"><p>:</p></td>
                ...
                <tr>
                    <td valign="top"><p>Alamat Perusahaan</p></td>
                    <td valign="top"><p>:</p></td>
                    <td><p>{{$item->alamat_usaha}}</p></td>
                </tr>
                <tr>
                    <td valign="top"><p>No. Telepon</p></td>
                    <td valign="top"><p>:</p></td>
                    <td><p>{{$item->telepon}}</p></td>
                </tr>
                <tr>
                    <td valign="top"><p>Jumlah Karyawan</p></td>
                    <td valign="top"><p>:</p></td>
                    <td><p>{{$item->jumlah_karyawan}} Orang</p></td>
                </tr>
                <tr>
                    <td valign="top"><p>Nilai Aset</p></td>
                    <td valign="top"><p>:</p></td>
                    <td><p>{{"Rp ".number_format($item->nilai_aset,2,',','.')}}</p></td>
                </tr>
            </table>
        </td>
    </tr>
