...
<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="number" value="{{$data->jumlah_karyawan}}" class="form-control @if($errors->get('jumlah_karyawan')) is-invalid @endif" name="jumlah_karyawan" placeholder="Jumlah Karyawan">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="number" value="{{$data->nilai_aset}}" class="form-control @if($errors->get('nilai_aset')) is-invalid @endif" name="nilai_aset" placeholder="Nilai Aset">
