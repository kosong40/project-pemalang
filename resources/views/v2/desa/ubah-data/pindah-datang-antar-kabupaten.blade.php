<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <option value="{{Kustom::exp($data->provinsi_1)[0]}}">{{Kustom::exp($data->provinsi_1)[1]}}</option>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <select id="kabupaten" name="kabupaten_1[]" class="select2 form-control @if($errors->get('kabupaten_1')) is-invalid @endif"
                ...
                <option value="{{Kustom::exp($data->kabupaten_1)[0]}}">{{Kustom::exp($data->kabupaten_1)[1]}}</option>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <select id="kecamatan" name="kecamatan_1[]" class="select2 form-control @if($errors->get('kecamatan_1')) is-invalid @endif"
                ...
                <option value="{{Kustom::exp($data->kecamatan_1)[0]}}">{{Kustom::exp($data->kecamatan_1)[1]}}</option>
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9" >
            <select id="desa" name="desa_1[]" class="select2 form-control @if($errors->get('desa_1')) is-invalid @endif"
                ...
                <option value="{{Kustom::exp($data->desa_1)[0]}}">{{Kustom::exp($data->desa_1)[1]}}</option>
            </select>
...
<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <input type="text" class="form-control" readonly nama="desa_2" value="{{$daerah->nama_daerah}}"
...
<script>
    ...
    $(function(){
        ...
        var idProv = {{Kustom::exp($data->provinsi_1)[0]}}
        console.log(idProv)
