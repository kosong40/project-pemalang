<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{$data->keperluan_bangunan}}"
                class="form-control @if($errors->get('keperluan_bangunan')) is-invalid @endif" name="keperluan_bangunan"
                placeholder="Keperluan Bangunan">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{$data->konstruksi_bangunan}}"
                class="form-control @if($errors->get('konstruksi_bangunan')) is-invalid @endif"
                name="konstruksi_bangunan" placeholder="Konstruksi Bangunan">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{$data->letak_bangunan}}"
                class="form-control @if($errors->get('letak_bangunan')) is-invalid @endif" name="letak_bangunan"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 input-group mb-3">
            <input type="text" value="{{$data->luas_bangunan}}"
                class="form-control @if($errors->get('luas_bangunan')) is-invalid @endif" name="luas_bangunan"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 input-group mb-3">
            <input type="text" value="{{$data->luas_tanah}}"
                class="form-control @if($errors->get('luas_tanah')) is-invalid @endif" name="luas_tanah"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{$data->tanah_milik}}"
                class="form-control @if($errors->get('tanah_milik')) is-invalid @endif" name="tanah_milik"
                placeholder="Pemilik Tanah">
...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="custom-file col-sm-9">
            <input type="file" class="form-control @if($errors->get('scan_persetujuan_tetangga')) is-invalid @endif"
                name="scan_persetujuan_tetangga">
    ...
    <div class="row">
        ...
        <div class="custom-file col-sm-9">
            <input type="file" class="form-control @if($errors->get('scan_fc_kepemilikan_tanah')) is-invalid @endif"
                name="scan_fc_kepemilikan_tanah">
    ...
    <div class="row">
        ...
        <div class="custom-file col-sm-9">
            <input type="file" class="form-control @if($errors->get('scan_fc_sppt_pbb_terakhir')) is-invalid @endif"
                name="scan_fc_sppt_pbb_terakhir">
    ...
    <div class="row">
        ...
        <div class="custom-file col-sm-9">
            <input type="file" class="form-control @if($errors->get('scan_gambar_rencana')) is-invalid @endif"
                name="scan_gambar_rencana">
    ...
    <div class="row">
        <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Scan Pengantar IMB dari
            {{$daerah->jenis_daerah}}</label>
        <div class="custom-file col-sm-9">
            <input type="file" class="form-control @if($errors->get('scan_pengantar')) is-invalid @endif"
                name="scan_pengantar">
