<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{old('calon_suami')}}" class="form-control @if($errors->get('calon_suami')) is-invalid @endif" name="calon_suami" placeholder="Nama Calon Suami">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="number" value="{{old('umur_calon_suami')}}" class="form-control @if($errors->get('umur_calon_suami')) is-invalid @endif" name="umur_calon_suami" placeholder="Umur Calon Suami">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" value="{{old('calon_istri')}}" class="form-control @if($errors->get('calon_istri')) is-invalid @endif" name="calon_istri" placeholder="Nama Calon Istri">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="number" value="{{old('umur_calon_istri')}}" class="form-control @if($errors->get('umur_calon_istri')) is-invalid @endif" name="umur_calon_istri" placeholder="Umur Calon Istri">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="date" value="{{old('tanggal_nikah')}}" class="form-control @if($errors->get('tanggal_nikah')) is-invalid @endif" name="tanggal_nikah">
