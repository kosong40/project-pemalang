...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{url('img/pemalang.jpg')}}) center/cover no-repeat">
            <div class="auth-box on-sidebar">
                <div id="loginform">
                    <div class="logo">
                        <h5 class="font-medium m-b-20">Login In Admin</h5>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
