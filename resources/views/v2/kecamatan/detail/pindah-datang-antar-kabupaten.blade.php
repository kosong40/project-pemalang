    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show" id="tujuan" role="tabpanel" aria-labelledby="pills-timeline-tab">
            <div class="card-body">
                ...
                <small class="text-muted">Alamat</small>
                <h6>{{Kustom::kapital($data->alamat_2) ." RT: $data->rt_2 RW: $data->rw_2 DUSUN ". Kustom::kapital($data->dusun_1) ." DESA ". Kustom::exp($data->desa_1)[1]." KECAMATAN ".Kustom::exp($data->kecamatan_1)[1]." ".Kustom::exp($data->kabupaten_1)[1]." PROVINSI ".Kustom::exp($data->provinsi_1)[1]}}</h6>
                <small class="text-muted">Kode Pos</small>
