...
@section('title',"Pemohon $data->nama ($data->kode)")
@section('breadcrumb')
...
<li class="breadcrumb-item"><a href="{{url('kecamatan/v2/data-layanan/'.$layanan->slug.'/'.$sublayanan->slug)}}">{{$sublayanan->subpelayanan}}</a></li>
