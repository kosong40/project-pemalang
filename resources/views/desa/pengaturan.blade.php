                ...
                <div class="col-sm-9">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#info" data-toggle="tab">Info Desa / Kelurahan</a></li>
                        </ul> {{--end list tabs--}}
                        <div class="tab-content">
                            <div class="active tab-pane" id="profil">
                                <h4 class="text-center">Profil Admin</h4>
                                <div>
                                    <form action="{{route('akunDesa')}}" method="post" class="form-horizontal">
                                        @csrf
                            ...
                            <div class="tab-pane" id="info">
                                ...
                                @foreach ($daerah->where('admin_id',$admin->id) as $daerah )
                                    <form method="post" action="{{route('gantiInfoDesa',$daerah->id)}}" class="form-horizontal">
                                    @csrf
                                        <div class="form-group">
                                            <label for="kontak" class="col-sm-3 control-label">Nama Kepala Desa / Lurah </label>
                                            <div class="col-sm-9">
                                                <input type="text" name="kades" value="{{$daerah->kepala_daerah}}" id="kontak" class="form-control">
                                                @if($errors->get('kades'))
                                                    @foreach ($errors->get('kades') as $pesan)
                                                        <li><label for="" style="color:#f56954">{{$pesan}}</label></li>
                                                    @endforeach
                                                @endif
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="kontak" class="col-sm-3 control-label">NIP Kepala Desa / Lurah</label>
                                            <div class="col-sm-9">
                            ...
                            <div class="tab-pane" id="password">
                                ...
                                <div>
                                    <form action="{{route('passAdminDesa')}}" method="post" class="form-horizontal">
                                    @csrf
                                        <div class="form-group">
